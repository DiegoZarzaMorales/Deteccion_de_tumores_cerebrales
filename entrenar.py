...
##  python entrenar.py --device cuda --epochs 100 --batch-size 8 --learning-rate 0.0001 --checkpoint-every 80 --num-workers 2 --persistent-workers --prefetch-factor 2 --data-dir "C:\Users\RESURGE\Desktop\learn-resources\BraTS-PEDs-v1\Training"
